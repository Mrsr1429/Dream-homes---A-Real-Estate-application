...
public class DetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bookProperty.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Check if user is logged in before allowing to book
                if (AuthHelper.requireLogin(DetailsActivity.this, "You need to login to book this property")) {
                    // Send SMS to owner's contact number
                    String message = "Hi " + ownerNameTextView.getText().toString() + 
                                   ", I am interested in booking your property at " + 
                                   locationTextView.getText().toString() + 
                                   ". Price: " + priceTextView.getText().toString() + 
                                   ". Please contact me for further details. Thank you.";
                    sendSMS(contactNoTextView.getText().toString(), message);
                }
            }
        });
        ...
        if (intent != null) {
            ...
            // Set onClickListener for callButton
            callButton.setOnClickListener(v -> {
                // Check if user is logged in before allowing to call
                if (AuthHelper.requireLogin(this, "You need to login to contact the property owner")) {
                    // Directly call the owner's phone number
            ...
            favButton.setOnClickListener(v -> {
                ...
                if (AuthHelper.requireLogin(this, "You need to login to add properties to favorites")) {
