        ...
        switch (item.getItemId()){
            ...
            case R.id.menu_favourite:
                ...
                if (!AuthHelper.isUserLoggedIn()) {
                    AuthHelper.requireLogin(this, "You need to login to view your favorite properties");
                    return false; // Don't switch fragment
                }
                fragment = new FavouriteFragment();
                break;
            case R.id.menu_account:
                // Require login for account
                if (!AuthHelper.isUserLoggedIn()) {
                    AuthHelper.requireLogin(this, "You need to login to access your account");
                    return false; // Don't switch fragment
                }
